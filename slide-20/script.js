...
document.addEventListener('DOMContentLoaded', () => {
    ...
    /* ═══════════════════════════════════════════════════════════
       GALLERY (same technique as slide-04)
       ═══════════════════════════════════════════════════════════ */
    ...
    const imageTriggers = document.querySelectorAll('.cicd-image');
    ...
    imageTriggers.forEach((trigger, i) => {
        trigger.addEventListener('click', () => openGallery(i));
    });
    ...
    const images         = document.querySelectorAll('.cicd-image');
    ...
    images.forEach((img, i) => {
        setTransition(img,
            'opacity 0.7s cubic-bezier(0.22,1,0.36,1), transform 0.7s cubic-bezier(0.22,1,0.36,1)', 900 + i * 250);
    });
